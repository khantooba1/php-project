            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                    <div class="navbar-nav m-auto py-0">
                        ...
                        <a href="ccontact.php" style="font-size :13px" class="nav-item nav-link active">Client Contact</a>
                            ...
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="tcolhai">Name</th>
                                        <th scope="col" class="tcolhai">Email</th>
                                        <th scope="col" class="tcolhai">Message</th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td>
                                            <a href="del_contact.php?cont_del=<?php echo $row["contact_id"] ?>">
