...
$sql_table = "SELECT * FROM rev_feedback";

$result_table = mysqli_query($conn, $sql_table);

$row_count_table = mysqli_num_rows($result_table);
// if ($row_count == 0) {
//     echo "no records";
// }
                ...
                <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                    <div class="navbar-nav m-auto py-0">
                        ...
                        <a href="cprofile.php" style="font-size :12px" class="nav-item nav-link">Clients
                            Info</a>
                        <a href="client_feedback.php" style="font-size :12px" class="nav-item nav-link active">Clients Feedbacks</a>
        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-dark rounded h-100 p-4">
                    <h6 class="mb-4">Feedbacks and reviews</h6>

                    <div class="table-responsive">
                        <?php
                        if ($row_count_table > 0) {
                            ?>
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="tcolhai">Client Username</th>
                                        <th scope="col" class="tcolhai">Client F-name</th>
                                        <th scope="col" class="tcolhai">Client L-name</th>
                                        <th scope="col" class="tcolhai">Client email</th>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row" class="trowhai">
                                            <?php echo $row_table['pid'] ?>
                                        </td>
                                        <td scope="row" class="trowhai">
                                            <?php echo $row_table['pname'] ?>
                                        </td>
                                        <td scope="col" class="trowhai">
                                            <?php echo $row_table['plname'] ?>
                                        </td>
                                        <td scope="col" class="trowhai">
                                            <?php echo $row_table['pemail'] ?>
                                        </td>
                                        <td scope="col" class="trowhai">
                                            <?php echo $row_table['prevf'] ?>
                                        </td>


                                        <td>
                                            <a href="del_feedback_review.php?pid=<?php echo $row_table["pid"] ?>">
