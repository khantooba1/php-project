                    ...
                    <div class="p-5 my-5" style="background: rgba(33, 30, 28, 0.43);">
                        ...
                        <form method="post">
                            <div class="form-row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" style="color:white;" name="app_name"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="email" style="color:white;" name="app_email"
                            ...
                            <div class="form-row">
                                ...
                                <!-- <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" style="color:white;" name="serviceworker" class="form-control bg-transparent p-4"
                                            placeholder="service worker " required="required" />
                                    </div>
                                </div> -->
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" style="color:white;" name="servicetype"
                                            class="form-control bg-transparent p-4" Value="Hair colour 20,000" />
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 pr-lg-5 mb-5">
                    ...
                    <div class="d-flex justify-content-start mt-4">
                        <a class="btn btn-lg btn-primary btn-lg-square mr-2" href="https://twitter.com/i/flow/login"><i
