...
$sql = "SELECT * FROM appointment_info WHERE uid = '$uid'";
...
<body>
                ...
                <div class="navbar-nav m-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="appointmentview.php" class="dropdown-item active">View Appointment</a>
    ...
    <div class="jumbotron jumbotron-fluid BG-APP" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h3 class="text-white display-3 mb-4"> Your Appointments </h3>
    ...
    <div class="container-fluid pt-4 px-4" style="margin-top:-80px">
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-dark rounded h-100 p-4">
                    <h6 class="mb-4" style='color: white;'>Appointments</h6>
                            ...
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="tcolhai">Customer Name</th>
                                        <th scope="col" class="tcolhai">Customer email</th>
                                        <th scope="col" class="tcolhai">Appointment date</th>
                                        <th scope="col" class="tcolhai">Appointment time</th>
                                        <th scope="col" class="tcolhai">package type:</th>
                                        <th scope="col" class="tcolhai">E/D</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_Appoint.php?cpid=<?php echo $row["cid"] ?>">
                                                <button class="appbtn">Edit</button>
                                            </a>
                                            <a href="delete_Appoint.php?cpid=<?php echo $row["cid"] ?>">
                                                <button class="appbtn">Cancle</button>
                                            </a>
                                        </td>
                                    </tr>
                                </thead>
            ...
            <div class="row">
                <div class="col-lg-6 pr-lg-5 mb-5">
                    ...
                    <a class="btn btn-lg btn-primary btn-lg-square mr-2" href="https://twitter.com/i/flow/login"><i class="fab fa-twitter"></i></a>
                        ...
                        <a class="btn btn-lg btn-primary btn-lg-square mr-2" href="https://www.linkedin.com/login"><i
                                class="fab fa-linkedin-in"></i></a>
                        <a class="btn btn-lg btn-primary btn-lg-square" href="https://www.instagram.com/accounts/login/"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
