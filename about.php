    ...
    <div class="jumbotron jumbotron-fluid BG-APP" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            ...
            <div class="d-inline-flex align-items-center text-white">
                <!-- <p class="m-0"><a class="text-white" href="">Know many things</a></p>
                    ...
                    <div class="col-lg-6" style="min-height: 500px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100"
                                src="https://www.kapilssalon.com/wp-content/uploads/2021/03/Makeup-Course-720x480-1.jpg"
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="team position-relative overflow-hidden mb-5">
                            <img style="width:300px;height:300px" class="img-fluid"
                                src="https://img.freepik.com/free-photo/graceful-long-haired-ginger-girl-looking-shoulder-laughing-pretty-woman-beret-enjoying-walk_197531-11739.jpg"
                                alt="">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team position-relative overflow-hidden mb-5">
                            <img style="width:300px;height:300px" class="img-fluid"
                                src="https://i.pinimg.com/736x/76/af/5a/76af5aada99e620f883de13d790f8cf0.jpg" alt="">
                            <div class="position-relative text-center">
                                <div class="team-text bg-primary text-white">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team position-relative overflow-hidden mb-5">
                            <img style="width:300px;height:300px" class="img-fluid"
                                src="https://i.pinimg.com/736x/20/14/fe/2014fe980212621e55839d55601c80cd.jpg" alt="">
                            <div class="position-relative text-center">
                                <div class="team-text bg-primary text-white">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team position-relative overflow-hidden mb-5">
                            <img style="width:300px;height:300px" class="img-fluid"
                                src="https://images.unsplash.com/photo-1609241728358-53d49c22c01a?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGdpcmwlMjBwaWN0dXJlfGVufDB8fDB8fHww"
                                alt="">
                            <div class="position-relative text-center">
                                <div class="team-text bg-primary text-white">
            ...
            <div class="container pt-5">
                <div class="row">
                    <div class="col-lg-6 pr-lg-5 mb-5">
                        ...
                        <p>Elegance Salon is renowned for its exceptional range of top-notch services, ensuring that
                            every
                        ...
                        <div class="d-flex justify-content-start mt-4">
                            <a class="btn btn-lg btn-primary btn-lg-square mr-2"
                                href="https://twitter.com/i/flow/login"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square mr-2" href="https://www.facebook.com/"><i
                                    class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square mr-2"
                                href="https://www.linkedin.com/login"><i class="fab fa-linkedin-in"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square"
                                href="https://www.instagram.com/accounts/login/"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
