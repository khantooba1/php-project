        ...
        <div class="container py-5 ">
            ...
            <div class="row justify-content-center BG-APP-FORM mx-0">
                <div class="col-lg-6 py-5">
                    <div class="p-5 my-5" style="background: rgba(33, 30, 28, 0.53);">
                        <h1 class="text-white text-center mb-4">Make Appointment</h1>
                        <form method="post">
                            <div class="form-row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input style="color: white;" type="text" name="app_name"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input style="color: white;" type="email" name="app_email"
                                            class="form-control bg-transparent p-4" placeholder="Your Email"
                                            required="required" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="date" id="date" data-target-input="nearest">
                                            <input style="color: white;" type="text" name="app_date"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="time" id="time" data-target-input="nearest">
                                            <input style="color: white;" type="text" name="app_time"
                                                class="form-control bg-transparent p-4 datetimepicker-input"
                            ...
                            <div class="form-row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" class="form-label">Packages</label>
                                        <select name="servicetype" class="form-control">
                                            <?php
                                            if ($row_count > 0) {
                                                while ($row = mysqli_fetch_assoc($result_select)) {
                                                    ?>
                                                    <option value="<?php echo $row['package'] ?>">
                                ...
                                <!-- <div class="col-sm-6">
                                <div class="form-group">
                                    <input style="color: white;"  type="text" name="servicename" class="form-control bg-transparent p-4"
                                        placeholder="Service name" required="required" />
                                </div>
                            </div> -->

                                <div class="col-sm-6">
                                    <button class="btn btn-primary " type="submit" name="subBtn"
                ...
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100"
                            src="https://www.styllibcoiffure.com/wp-content/uploads/carousel-styl-lib-coiffure-1.jpg"
