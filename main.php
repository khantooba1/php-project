...
<div id="a1" class="anime square">
    <span class=""><img src="./images/loader.png" class="img-fluid" alt=""></span>
   </div>
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate__animated animate__fadeInDown"
                                style="letter-spacing: 3px;">Welcome to</h6>
                            <h3 class="display-3 text-capitalize text-white mb-3"> Elegance Salon</h3>
